...
public final class Utils {
     ...
     */
    public static List<News> fetchNewsData(String requestUrl,String country) {
        // Create URL object
        ...
        List<News> News = extractFeatureFromJson(jsonResponse,country);
     ...
     */
    private static List<News> extractFeatureFromJson(String NewsJSON,String nation) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(NewsJSON)) {
            return null;
        }

        List<News> news = QueryUtils.extractNews(NewsJSON,nation);
        return news;
    }
}
