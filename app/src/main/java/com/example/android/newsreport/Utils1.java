...
public final class Utils1 {
     ...
     */
    public static String fetchcountryData(String requestUrl) {
        // Create URL object
        ...
        String  country = extractFeatureFromJson(jsonResponse);
    ...
    private static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem retrieving the News JSON COUNTRY CORERGJFD results.", e);
        } finally {
     ...
     */
    private static String  extractFeatureFromJson(String NewsJSON) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(NewsJSON)) {
            return null;
        }

        String news = QueryUtils1.extractNews(NewsJSON);
        return news;
    }
}
